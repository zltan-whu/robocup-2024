...
namespace ego_planner
{
  ...
  private:
    ...
    std_msgs::Bool ego_init_msg_;//给控制器发送已经就绪的消息
    ...
    ros::Publisher ego_state_pub_, replan_pub_, new_pub_, bspline_pub_, data_disp_pub_, swarm_trajs_pub_, broadcast_bspline_pub_,have_target_pub_;
